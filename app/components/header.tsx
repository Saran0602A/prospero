  ...
  return (
    ...
    >
      ...
      <nav className="hidden md:flex space-x-8 text-lg font-medium text-[#1f1f1f]">
        <Link href="/Find" className="hover:text-[#14213d] transition-colors">Find</Link>
        <Link href="/Offer" className="hover:text-[#14213d] transition-colors">Offer</Link>
        <Link href="/About" className="hover:text-[#14213d] transition-colors">About</Link>
        <Link href="/Contact" className="hover:text-[#14213d] transition-colors">Contact</Link>
      </nav>

      {/* Desktop Auth / User Name */}
      <div className="hidden md:flex space-x-5 text-lg font-medium">
        {userName ? (
          <span className="px-4 py-2 rounded-lg bg-[#14213d] text-white shadow-sm">{userName}</span>
        ) : (
          <>
            <Link
              href="/Signin"
      ...
      >
        <nav className="flex flex-col items-center space-y-5 py-6 text-xl font-semibold">
          <Link href="/Find" onClick={() => setIsOpen(false)}>Find</Link>
          ...
          <div className="flex space-x-4">
            {userName ? (
              <span className="px-5 py-2 rounded-lg bg-[#14213d] text-white">{userName}</span>
            ) : (
              <>
                <Link
                  href="/Signin"
